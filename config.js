module.exports = {
    ...
    server: {
        guildId: '1451502812688158753',         // ايدي السيرفر
        broadcastRoleId: '1451558479478263831', // ايدي الرول اللي يستخدم عليها البوت
        reportChannelId: '1451558542984089690' // ايدي الروم اللي يرسل فيه البوت التقارير
    },
    broadcast: {
